...
def playout(state, player, debug=False):
	...
	val = playout(nextState, nextPlayer, debug)
	...
	if debug:
		...
		print(val)
		print(np.unique(np.array(values)))
		print("===============================")
...
valueNetwork.load_state_dict(torch.load("models/valueNet-9.pth", map_location=torch.device('cpu')))
#r = randomState()
#print(value(r))
#for state, player in possibleMoves(r, 1):
#	printState(state)
#	print(value(state))
#	print(player)
#	print("===================")
#drawState(r)
playout(startState(), 1, True)
